...
3.  How many variables are in the data set? R\\ 8

4.  How many observations are in the data set? R\\ 344
...
5.  What data types are contained in the variables? (Reminder: <https://ds4owd-001.github.io/website/slides/lec-02-visualisation.html#/types-of-variables>)
    ...
    -   Categorical data (Species, Island, Sex)
...
```{r}
penguins |> 
  mutate(body_ration = bill_length_mm/bill_depth_mm)
```
